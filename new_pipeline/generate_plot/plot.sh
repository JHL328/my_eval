...
PLOT_DIR="/mnt/weka/home/haolong.jia/eval/data-engineering/evals/new_sources_august"
mkdir -p "$PLOT_DIR"
...
commands=(
    # --- BBH Plots (pass@k) ---
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/bbh_pass16/passk.json --output ${PLOT_DIR}/base/bbh_pass@1.pdf --metric pass@1 --task bbh"
    

    # # --- MMLU (Standard) Plots (pass@k) ---
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mmlu/passk.json --output ${PLOT_DIR}/base/mmlu_std_pass@1.pdf --metric pass@1 --task mmlu_std"

    # # --- MMLU (CoT) Plots (pass@k) ---
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mmlu_flan_pass16/passk.json --output ${PLOT_DIR}/base/mmlu_cot_pass@1.pdf --metric pass@1 --task mmlu_cot"
    
    # # --- MMLU-Pro Plots (pass@k) ---
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mmlu_pro_pass16/passk.json --output ${PLOT_DIR}/base/mmlu_pro_pass@1.pdf --metric pass@1 --task mmlu_pro"

    # # # --- MATH & Code Plots (pass@k) ---
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/math500_pass64/passk.json --output ${PLOT_DIR}/math/math500_pass@1.pdf --metric pass@1 --task math500"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/math500_pass64/passk.json --output ${PLOT_DIR}/math/math500_pass@8.pdf --metric pass@8 --task math500"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/math500_pass64/passk.json --output ${PLOT_DIR}/math/math500_pass@16.pdf --metric pass@16 --task math500"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/math500_pass64/passk.json --output ${PLOT_DIR}/math/math500_pass@32.pdf --metric pass@32 --task math500"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/math500_pass64/passk.json --output ${PLOT_DIR}/math/math500_pass@64.pdf --metric pass@64 --task math500"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/gsm8k_pass16/passk.json --output ${PLOT_DIR}/math/gsm8k_pass@1.pdf --metric pass@1 --task gsm8k"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/gsm8k_pass16/passk.json --output ${PLOT_DIR}/math/gsm8k_pass@8.pdf --metric pass@8 --task gsm8k"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/gsm8k_pass16/passk.json --output ${PLOT_DIR}/math/gsm8k_pass@16.pdf --metric pass@16 --task gsm8k"
    ...
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/humaneval/base_passk.json --output ${PLOT_DIR}/code/humaneval_base_pass16.pdf --metric pass@16 --task humaneval"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/humaneval/plus_passk.json --output ${PLOT_DIR}/code/humaneval_plus_pass16.pdf --metric pass@16 --task humaneval+"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/humaneval/base_passk.json --output ${PLOT_DIR}/code/humaneval_base_pass1.pdf --metric pass@1 --task humaneval"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/humaneval/plus_passk.json --output ${PLOT_DIR}/code/humaneval_plus_pass1.pdf --metric pass@1 --task humaneval+"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/base_passk.json --output ${PLOT_DIR}/code/mbpp_base_pass16.pdf --metric pass@16 --task mbpp"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/plus_passk.json --output ${PLOT_DIR}/code/mbpp_plus_pass16.pdf --metric pass@16 --task mbpp+"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/base_passk.json --output ${PLOT_DIR}/code/mbpp_base_pass1.pdf --metric pass@1 --task mbpp"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/plus_passk.json --output ${PLOT_DIR}/code/mbpp_plus_pass1.pdf --metric pass@1 --task mbpp+"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/base_passk.json --output ${PLOT_DIR}/code/mbpp_base_pass32.pdf --metric pass@32 --task mbpp"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/plus_passk.json --output ${PLOT_DIR}/code/mbpp_plus_pass32.pdf --metric pass@32 --task mbpp+"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/base_passk.json --output ${PLOT_DIR}/code/mbpp_base_pass64.pdf --metric pass@64 --task mbpp"
    "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/mbpp/plus_passk.json --output ${PLOT_DIR}/code/mbpp_plus_pass64.pdf --metric pass@64 --task mbpp+"
