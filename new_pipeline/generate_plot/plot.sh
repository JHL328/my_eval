...
commands=(
    ...
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/gsm8k_pass16/passk.json --output ${PLOT_DIR}/gsm8k_pass@1.pdf --metric pass@1 --task gsm8k"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/gsm8k_pass16/passk.json --output ${PLOT_DIR}/gsm8k_pass@8.pdf --metric pass@8 --task gsm8k"
    # "python ${PLOT_SCRIPT} --passk ${RESULT_DIR}/gsm8k_pass16/passk.json --output ${PLOT_DIR}/gsm8k_pass@16.pdf --metric pass@16 --task gsm8k"
